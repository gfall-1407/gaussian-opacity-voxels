...
class Scene:
    ...
    def __init__(self, args : ModelParams, govs : GovsTCNNModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        """b
    ...
    def save(self, iteration):
        ...
        self.govs.save_ply(os.path.join(point_cloud_path, "point_cloud.ply"))
