...
class _RasterizeGovs(torch.autograd.Function):
    @staticmethod
    def forward(
        ctx,
        means3D,
        ...
        args = (
            ...
            raster_settings.render_outside,
            scales,
            rotations,
...
class GovsRasterizationSettings(NamedTuple):
    image_height: int
    image_width: int
...
class GovsRasterizer(nn.Module):
